...
export default function AppStoreBanner() {
    return (
        <>
            <div className='bg-gray-100 dark:bg-gray-800 dark:text-white py-10' style={bannerImg}>
                <div className="container">
                    <div className='space-y-6 max-w-xl mx-auto'>
                        <h1 data-aos="slide-up" className='text-2xl text-clip text-center sm:text-4xl font-semibold'>Read Books at your fingertips</h1>
