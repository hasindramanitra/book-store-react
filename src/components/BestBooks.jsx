                      ...
                      BooksData.map((book) => (
                        ...
                        className='rounded-2xl bg-white dark:bg-gray-800 hover:bg-primary dark:hover:bg-primary hover:text-white relative shadow-xl duration-high group max-w-[300px]'>
                          ...
                          <div className='p-4 text-center'>
                            ...
                            <button className=' from-primary to-secondary text-white px-4 py-2 mt-4 rounded-full hover:scale-105 duration-200 group-hover:bg-white group-hover:text-primary'>Order Now</button>
                          </div>
                        </div>
                      ))
                    }
